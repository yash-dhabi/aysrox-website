    ...
    <footer className="bg-primary text-primary-foreground py-12 border-t border-primary-foreground/10">
      <div className="container-width">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-primary-foreground/70 max-w-sm leading-relaxed mb-6">
              Global R&D outcomes studio helping researchers and innovators turn
              complex ideas into funded projects and real-world impact.
            </p>

            {/* Social Media Handles */}
            <div className="flex gap-4">
              <a
                href="https://www.linkedin.com/company/110394244"
                target="_blank"
        ...
        <div className="pt-8 border-t border-primary-foreground/10 text-center text-sm text-primary-foreground/50">
          &copy; {new Date().getFullYear()} AysRox Solutions. All rights
          reserved.
        </div>
      </div>
    </footer>
